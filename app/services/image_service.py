...
class ImageService:
    ...
    def rename_image(self, image_id: str, new_filename: str) -> Optional[Dict]:
        """
        Rename an image.
        ...
        Returns:
            Updated image metadata or None if failed
        ...
        try:
            self.es.update('elaslip_images', image_id, {'doc': {'filename': new_filename}})
            return metadata
