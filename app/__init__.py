...
def create_app(config_name=None):
    ...
    def inject_config():
        ...
        return {
            'SITE_NAME': app.config.get('SITE_NAME', 'ELASLIP'),
            'SITE_TITLE': app.config.get('SITE_TITLE', 'ELASLIP'),
    ...
    from app.tasks import scan_tasks, webhook_tasks, urlscan_tasks, report_tasks
