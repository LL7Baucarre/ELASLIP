...
INDICES = {
    "elasmisp_ioc": IOC_MAPPING,
    "elasmisp_users": USERS_MAPPING,
    "elasmisp_api_keys": API_KEYS_MAPPING,
    "elasmisp_api_configs": API_CONFIGS_MAPPING,
    "elasmisp_webhooks": WEBHOOKS_MAPPING,
    "elasmisp_webhook_logs": WEBHOOK_LOGS_MAPPING,
    "elasmisp_enrichment_cache": ENRICHMENT_CACHE_MAPPING,
    "elasmisp_import_jobs": IMPORT_JOBS_MAPPING,
    "elasmisp_scan_results": SCAN_RESULTS_MAPPING,
    "elasmisp_ioc_relations": IOC_RELATIONS_MAPPING,
    "elasmisp_audit_logs": AUDIT_LOGS_MAPPING,
    "elasmisp_ioc_versions": IOC_VERSIONS_MAPPING,
    "elasmisp_roles": ROLES_MAPPING,
    "elasmisp_cases": CASES_MAPPING,
    "elasmisp_incidents": INCIDENTS_MAPPING,
    "elasmisp_timeline_events": TIMELINE_EVENTS_MAPPING,
    "elasmisp_comments": COMMENTS_MAPPING,
